...
# ==================================================================================================
"""
Cereate a job and start some tasks that read and write data.
"""
...
def main():
    ...
    job.upload("df_set_data.py")
    job.upload("df_get_data.py")
    ...
    develop_task = data_api.DataFlowTask(
        name = "df1",
        cmd_args = ["python", "df_set_data.py"],
    ...
    develop_task = data_api.DataFlowTask(
        name = "df2",
        cmd_args = ["python", "df_get_data.py"],
